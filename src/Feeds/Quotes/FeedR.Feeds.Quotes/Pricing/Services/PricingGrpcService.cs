...
// treat Grpc Services as a Controllers - so it should be thin and clean
// move application logic in the corresponding classes
        ...
        ServerCallContext context)
    {
        ...
        while (!context.CancellationToken.IsCancellationRequested)
        {
            ...
            await responseStream.WriteAsync(new PricingResponse
            {
                ...
                Value = (int) (currencyPair.Value * 100),
